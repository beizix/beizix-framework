...
public class ContentDispositionAttachController {
  ...
  ResponseEntity<Resource> operate(@PathVariable String disclosure, FileUploadInfo fileUploadInfo)
    ...
    String encodedUploadFileName =
        UriUtils.encode(fileUploadInfo.getOriginName(), StandardCharsets.UTF_8);
