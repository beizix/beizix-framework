package app.module.admin.usecase.exboard.excel.adapters.web;
...
import app.module.core.config.adapter.persistence.entity.ExBoard_;
...
import app.module.core.usecase.exboard.list.application.port.in.ExBoardListPortIn;
